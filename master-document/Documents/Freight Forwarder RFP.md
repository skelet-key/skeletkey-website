...
The logistics infrastructure must reliably sustain a factory throughput cadence of **40 motorcycles per working day** (10,000 units over a 250-day calendar year).
...
*   **Origin Ports:** Primarily East Asia (Ningbo/Shanghai/Shenzhen) and regional precision mechanical hubs.
*   **Destination Ports:** Staged directly to your chosen Tier-1 contract manufacturer’s regional deepwater port hub.
*   **Throughput Cadence Requirements:** Propose a rolling container injection schedule delivering an average of **200 fully kitted component sets every 5 working days** to maintain a lean, 5-day just-in-time (JIT) safety stock buffer at the assembly floor.

## 4. Required Vendor Service Levels (SLAs)
Bidding freight forwarders must explicitly verify their capacity to meet the following parameters:
*   **Real-Time Telematics Tracking:** Continuous GPS and environmental tracking (temperature, humidity, shock sensors) for all powertrain/battery containers.
*   **Customs Clearance & Bonded Warehousing:** Guaranteed customs brokerage handling, automated HTS classification filing, and access to Foreign Trade Zone (FTZ) or bonded staging to optimize tariff outlays.
...
| Logistics Cost Component | Pricing Unit / Metric | Target Cap / Reference | Bidder Quote ($) |
| :--- | :--- | :--- | :--- |
| **Ocean Freight (FCL 40' HC)** | Per Container (Base Ocean Rate) | Lane Dependent | |
| **Class 9 HazMat Surcharge** | Per Powertrain Container | Compliant with UN38.3 | |
| **Origin / Destination Handling** | Per Container Port Fees | Standard Local Charges | |
| **Customs Brokerage Clearance** | Per Entry Filing Fee | Fixed Flat Rate | |
| **Inland Drayage Transport** | Port to Tier-1 Assembly Plant | Per Mile / Zone Rate | |